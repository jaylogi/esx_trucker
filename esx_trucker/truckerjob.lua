...
TruckingCompany[0] = {["x"] = 846.38,["y"] = -902.62, ["z"] = 25.25}
...
local MissionData = {
    ...
    [1] = {2553.79, 436.70, 108.45, 300},
    [2] = {-2529.72, 2341.95, 32.56, 550},
...
function MISSION.spawnTruck()
    ...
    MISSION.truck = CreateVehicle(MISSION.hashTruck, 871.92, -912.97, 26.05, 356.04, true, false)
...
function MISSION.getMoney()
   TriggerServerEvent("esx_247:pay", currentMission[4])
...
function GUI.init()
    ...
    GUI.addButton(0, "Van trailer", GUI.optionMisson, 0.35, 0.35, 0.3, 0.05 )
    ...
    GUI.addButton(1, "Mission 3 [ 550$ ]", GUI.mission, 0.35, 0.35, 0.3, 0.05)
